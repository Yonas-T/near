...
class UnencryptedFileSystemKeyStore extends KeyStore {
  ...
  Future setKey(String networkId, String accountId, KeyPair keyPair) async {
        ...
        AccountInfo account = AccountInfo(accountId: accountId, publicKey: KeyPairEd25519(
          // keyPair.toString()
          ).getPublicKey().toString(), privateKey: keyPair.toString());
